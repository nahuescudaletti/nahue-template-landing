...
export function ChooseYourCards() {
    return (
        <div className="relative px-6 py-20 md:py-40" id="tarjetas">
            <BackgroundRadialRight />
            <div className="block max-w-5xl mx-auto md:grid md:grid-cols-2">
                <Reveal>
                    <h2 className="text-5xl font-semibold">Lorem ipsum dolor sit amet.
                        <span className="block degradedBlue bg-OrangeLight">Lorem ipsum dolor .</span>
                    </h2>
                </Reveal>
                <div className="px-5">
                    <MotionTransition>
